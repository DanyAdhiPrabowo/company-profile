            ...
            <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
              ...
              <div class="carousel-inner">
                <div class="carousel-item active">
                  <img class="d-block w-100" src="{{asset('user/images/gallery/prambanan.png')}}" alt="First slide" style="object-fit:cover; width:100%; height:768px">
                </div>
                <div class="carousel-item">
                  <img class="d-block w-100" src="{{asset('user/images/gallery/wisata4.png')}}" alt="Second slide" style="object-fit:cover; width:100%; height:768px">
                </div>
                <div class="carousel-item">
                  <img class="d-block w-100" src="{{asset('user/images/gallery/wisata5.png')}}" alt="Third slide" style="object-fit:cover; width:100%; height:768px">
                </div>
                <div class="carousel-item">
                  <img class="d-block w-100" src="{{asset('user/images/gallery/wisata6.png')}}" alt="Four slide" style="object-fit:cover; width:100%; height:768px">
                </div>
                <div class="carousel-item">
                  <img class="d-block w-100" src="{{asset('user/images/gallery/wisata7.png')}}" alt="Five slide" style="object-fit:cover; width:100%; height:768px">
                </div>
                <div class="carousel-item">
                  <img class="d-block w-100" src="{{asset('user/images/gallery/wisata8.png')}}" alt="Six slide" style="object-fit:cover; width:100%; height:768px">
                </div>
              </div>
