        ...
        <div class="card-body">
          ...
          <form action="{{route('articles.update', [$article->id])}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="col-10">
              ...
              <div class="mb-3">
                <label for="slug" class="font-weight-bold d-flex">Image</label>
                @if($article->thumbnail)
                  <img src="{{asset('article_image/'.$article->thumbnail)}}" alt="" width="120px">
                @else
                  No Image
                @endif
                <input type="file" name="thumbnail" class="form-control {{$errors->first('thumbnail') ? "is-invalid" : ""}}">
